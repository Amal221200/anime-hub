        ...
        <main>
            <SectionContainer>
                <div className={cn('space-y-3',
                    'prose-headings:font-semibold prose-a:text-gray-300 prose-h1:mb-4 prose-h1:text-4xl prose-h3:text-2xl prose-p:mb-6 prose-p:text-sm prose-img:mx-auto prose-img:my-4 prose-img:aspect-video prose-img:h-auto prose-img:w-[700px] prose-img:rounded prose-img:object-cover hover:prose-a:underline prose-img:object-bottom sm:prose-h1:text-6xl sm:prose-h3:text-2xl sm:prose-p:text-base'
                )}>
                    {blogContent}
                </div>
            </SectionContainer>
