                    ...
                    <div className="flex w-full flex-grow-[1] flex-col justify-between md:basis-2">
                        ...
                        <ul className="space-y-2 py-3">
                            ...
                            <li className="flex items-center gap-2">
                                <Link href={anime.watchLink} target="_blank" className="rounded-md bg-emerald-400 px-2 py-1 transition-all hover:bg-emerald-500">
                                    Watch Anime <Play className="inline rounded-full border-2 border-black p-[2px]" size={18} />
                                </Link>
                            </li>
                        </ul>
                    </div>
