...
const AnimeBody = ({ showHeading, ...props }: { showHeading: boolean, artists: { artist: string }[], studios: { studio: string }[], genres: string[] }) => {
    ...
    return (
        <>
            ...
            <AnimeSection heading={showHeading ? `Search Results` : 'All Animes'} className='min-h-[calc(100dvh-160px)' />
        </>
    )
}
